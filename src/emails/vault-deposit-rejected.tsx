...
interface VaultDepositRejectedProps {
...
export const VaultDepositRejected = ({
  recipientName,
  depositAmount,
  transactionId,
  rejectedDate,
  reason,
}: VaultDepositRejectedProps) => {
  return (
    <div
      style={{
            ...
            >
              ...
              <tr>
                <td style={{ padding: '20px 40px', textAlign: 'center' }}>
                  ...
                  >
                    Hi {recipientName}, we regret to inform you that your vault
                  ...
                  >
                    ...
                    >
                      If you have any questions about this decision or would
                      like to submit a new deposit request, please contact our
                      support team.
                    </p>
                  </div>
                  ...
                  >
                    ...
                    contact our support team at {appConfig.emails.support}.
                  </p>
                </td>
              </tr>
              <tr>

...
import { useMyWithdrawalRequests } from '@/hooks/queries/withdrawal-request';
      ...
      <CardContent className='flex flex-col items-center justify-center py-16'>
        <div className='text-center'>
          ...
          <p className='text-sm text-muted-foreground'>
            You haven't made any withdrawal requests yet. Click "Request
            Withdrawal" to get started.
          </p>
        </div>
      </CardContent>
    </Card>

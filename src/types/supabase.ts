    ...
    Tables: {
      ...
      applications: {
        Row: {
          ...
          preferred_ownership_path: string | null;
      ...
      property: {
        Row: {
          ...
          annual_yield_max: number | null;
          annual_yield_min: number | null;
          ...
          created_at: string;
          description: string;
          earnings_active_since: string | null;
          furnishing_cost: number;
          id: string;
          images: string[];
          last_distribution_at: string | null;
          legal_setup_cost: number;
          listing_date: string | null;
          listed_value: number | null;
          managed_by_vestafi: boolean;
          ...
          operational_setup_cost: number;
          opportunity_type: string;
          ownership_proof: string[] | null;
          price: number;
          price_usd: number | null;
          prime_highlights: string[];
          ...
          starting_ownership_amount: number | null;
          title: string;
    ...
    Views: {
      ...
      listings_view: {
        Row: {
          ...
          annual_yield_max: number | null;
          annual_yield_min: number | null;
          apartment_features: string[] | null;
          ...
          last_distribution_at: string | null;
          legal_setup_cost: number | null;
          listed_value: number | null;
          managed_by_vestafi: boolean | null;
          ...
          next_distribution_at: string | null;
          occupancy_percentage: number | null;
          operational_setup_cost: number | null;
          opportunity_type: string | null;
          price: number | null;
          prime_highlights: string[] | null;
          property_type:
